...
pub trait Handler: Send + Sync + 'static {
    ...
    async fn handle_oauth_exchange(
        ...
        Err(Status::unimplemented("handle_oauth_exchange method is not implemented"))
    }
    ...
    async fn handle_register_device(
        ...
        Err(Status::unimplemented("handle_register_device method is not implemented"))
    }
    ...
    async fn handle_list_devices(
        ...
        Err(Status::unimplemented("handle_list_devices method is not implemented"))
    }
    ...
    async fn handle_delete_device(
        ...
        Err(Status::unimplemented("handle_delete_device method is not implemented"))
    }
    ...
    async fn handle_update_device_info(
        ...
        Err(Status::unimplemented("handle_update_device_info method is not implemented"))
    }
    ...
    async fn handle_request_encryption_key(
        ...
        Err(Status::unimplemented("handle_request_encryption_key method is not implemented"))
    }
    ...
    async fn handle_upload_file(
        ...
        Err(Status::unimplemented("handle_upload_file method is not implemented"))
    }
    ...
    async fn handle_download_file(
        ...
        Err(Status::unimplemented("handle_download_file method is not implemented"))
    }
    ...
    async fn handle_list_files(
        ...
        Err(Status::unimplemented("handle_list_files method is not implemented"))
    }
    ...
    async fn handle_delete_file(
        ...
        Err(Status::unimplemented("handle_delete_file method is not implemented"))
    }
    ...
    async fn handle_find_file_by_criteria(
        ...
        Err(Status::unimplemented("handle_find_file_by_criteria method is not implemented"))
    }
    ...
    async fn handle_check_file_exists(
        ...
        Err(Status::unimplemented("handle_check_file_exists method is not implemented"))
    }
    ...
    async fn handle_register_watcher_preset(
        ...
        Err(Status::unimplemented("handle_register_watcher_preset method is not implemented"))
    }
    ...
    async fn handle_update_watcher_preset(
        ...
        Err(Status::unimplemented("handle_update_watcher_preset method is not implemented"))
    }
    ...
    async fn handle_get_watcher_preset(
        ...
        Err(Status::unimplemented("handle_get_watcher_preset method is not implemented"))
    }
    ...
    async fn handle_register_watcher_group(
        ...
        Err(Status::unimplemented("handle_register_watcher_group method is not implemented"))
    }
    ...
    async fn handle_update_watcher_group(
        ...
        Err(Status::unimplemented("handle_update_watcher_group method is not implemented"))
    }
    ...
    async fn handle_delete_watcher_group(
        ...
        Err(Status::unimplemented("handle_delete_watcher_group method is not implemented"))
    }
    ...
    async fn handle_get_watcher_group(
        ...
        Err(Status::unimplemented("handle_get_watcher_group method is not implemented"))
    }
    ...
    async fn handle_get_watcher_groups(
        ...
        Err(Status::unimplemented("handle_get_watcher_groups method is not implemented"))
    }
    ...
    async fn handle_health_check(
        ...
        Err(Status::unimplemented("handle_health_check method is not implemented"))
    }
    ...
    async fn handle_validate_token(
        ...
        Err(Status::unimplemented("handle_validate_token method is not implemented"))
    }
    ...
    async fn handle_check_auth_status(
        ...
        Err(Status::unimplemented("handle_check_auth_status method is not implemented"))
    }
    ...
    async fn handle_sync_configuration(
        ...
        Err(Status::unimplemented("handle_sync_configuration method is not implemented"))
    }
    ...
    async fn handle_get_account_info(
        ...
        Err(Status::unimplemented("handle_get_account_info method is not implemented"))
    }
    ...
    async fn handle_login(
        ...
        Err(Status::unimplemented("handle_login method is not implemented"))
    }
    ...
    async fn handle_verify_login(
        ...
        Err(Status::unimplemented("handle_verify_login method is not implemented"))
    }
    ...
    async fn handle_subscribe_to_auth_updates(
        ...
        Err(Status::unimplemented("handle_subscribe_to_auth_updates method is not implemented"))
    }
    ...
    async fn handle_subscribe_to_device_updates(
        ...
        Err(Status::unimplemented("handle_subscribe_to_device_updates method is not implemented"))
    }
    ...
    async fn handle_subscribe_to_encryption_key_updates(
        ...
        Err(Status::unimplemented("handle_subscribe_to_encryption_key_updates method is not implemented"))
    }
    ...
    async fn handle_subscribe_to_file_updates(
        ...
        Err(Status::unimplemented("handle_subscribe_to_file_updates method is not implemented"))
    }
    ...
    async fn handle_subscribe_to_watcher_preset_updates(
        ...
        Err(Status::unimplemented("handle_subscribe_to_watcher_preset_updates method is not implemented"))
    }
    ...
    async fn handle_subscribe_to_watcher_group_updates(
        ...
        Err(Status::unimplemented("handle_subscribe_to_watcher_group_updates method is not implemented"))
    }
    ...
    async fn handle_subscribe_to_version_updates(
        ...
        Err(Status::unimplemented("handle_subscribe_to_version_updates method is not implemented"))
    }
    ...
    async fn handle_get_file_history(
        ...
        Err(Status::unimplemented("handle_get_file_history method is not implemented"))
    }
    ...
    async fn handle_restore_file_version(
        ...
        Err(Status::unimplemented("handle_restore_file_version method is not implemented"))
    }
    ...
    async fn handle_broadcast_file_restore(
        ...
        Err(Status::unimplemented("handle_broadcast_file_restore method is not implemented"))
    }
