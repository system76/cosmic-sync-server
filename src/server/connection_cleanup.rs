...
impl ConnectionCleanupScheduler {
    ...
    pub async fn start(&self) -> tokio::task::JoinHandle<()> {
        ...
        info!("🧹 Starting connection cleanup scheduler (interval: {}h, max_age: {}h)", 
...
impl ConnectionStatsReporter {
    ...
    pub async fn start(&self) -> tokio::task::JoinHandle<()> {
        ...
        info!("📊 Starting connection stats reporter (interval: {}min)", report_interval_minutes);
        ...
        tokio::spawn(async move {
            ...
            loop {
                ...
                if stats.total_connections > 0 {
                    info!("📊 Connection stats: {} total ({} active, {} inactive)", 
                          stats.total_connections, stats.active_connections, stats.inactive_connections);
                } else {
